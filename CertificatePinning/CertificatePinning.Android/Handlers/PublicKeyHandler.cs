...
I0Puxib+3v+A0M8fL1J9"}    
        ...
        {
            var pubKeyString = Android.Util.Base64.EncodeToString(certificate.GetEncoded(), Android.Util.Base64Flags.Default);

            if (_allowedPubKeys.ContainsValue(pubKeyString))
            {
                return true;
            }
